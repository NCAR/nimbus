#! /usr/bin/perl
#
# NOTE: This version differs from the description below in that
#       it takes coordinates in the order longitude, then latitude.
#       Also, it reads from the subdirectory 'NavPoints' for VOR etc.
...
open(OPT,">VORDMECoordinates");
# open(KHD,"./NavPoints/kml.header");
# @lines = <KHD>;
# foreach (@lines) {
#       print TRK;
# }
