...
Begin VB.Form frmSpectrum 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmSpectrum.frx":0000
      ...
      Tab(0).Control(8)=   "Label(13)"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "picBandpass"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "cmdStart(2)"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "txtYY2"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "txtYY1"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "txtZp"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "chkShowUSBLSB"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "chkChannel(0)"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "chkChannel(2)"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).Control(17)=   "chkChannel(1)"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "txtXX1"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "txtXX2"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "cboLO(0)"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "cboLO(1)"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).Control(22)=   "cboLO(2)"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "cmdBP"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "txtYY3"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "txtXX3"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "cmdExit(1)"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "txtBPavgD(0)"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "txtBPrmsD(0)"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "txtBPrms(0)"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "txtBPavg(0)"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "txtBPavg(1)"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "txtBPrms(1)"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "txtBPrmsD(1)"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "txtBPavgD(1)"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "txtBPavg(2)"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "txtBPrms(2)"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "txtBPrmsD(2)"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "txtBPavgD(2)"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).ControlCount=   39
      TabCaption(1)   =   "Setup"
      TabPicture(1)   =   "frmSpectrum.frx":001C
      ...
      TabPicture(2)   =   "frmSpectrum.frx":0038
      ...
      Begin VB.ListBox lstZ 
         Height          =   1035
         ItemData        =   "frmSpectrum.frx":00D7
         Left            =   -68745
         List            =   "frmSpectrum.frx":00DE
         TabIndex        =   19
         Top             =   705
         Width           =   480
      End
...
Dim iMax%, IFfreq!(0 To 1000), BP!(1 To 3, 0 To 1000), BPwt!(0 To 3)
Dim fu!(1 To 3, 0 To 1000), FL!(1 To 3, 0 To 1000)
Dim Au!(1 To 3, 0 To 1000), Al!(1 To 3, 0 To 1000)
Dim AuL!(1 To 3, 0 To 1000), AlL!(1 To 3, 0 To 1000)
