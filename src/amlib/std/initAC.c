...
NR_TYPE (*pcorPSTF)(NR_TYPE, NR_TYPE, NR_TYPE, NR_TYPE), 
        (*pcorQCTF)(NR_TYPE, NR_TYPE, NR_TYPE, NR_TYPE);
...
// GV
	...
	pcorf5v2(NR_TYPE, NR_TYPE, NR_TYPE), pcortf5(NR_TYPE, NR_TYPE, NR_TYPE, NR_TYPE);
