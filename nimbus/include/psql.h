...
/* -------------------------------------------------------------------- */
typedef std::map<std::string, std::string> sampleRateTableMap;
...
//@}
   ...
   * @param srTable is the map being built.  A 'key' will be generated
   ...
   */
  void addToSampleRateList(sampleRateTableMap &srTable, const var_base *var);


  /**
   * Execute the SQL commands from the map generated by the
   * addToSampleRateList() method.
   * @see addToSampleRateList()
   */
  void createSampleRateTables(const sampleRateTableMap &srTable);
