...
/////////////////////////////////////////////////////////////////////
void Server::connectionStateChanged(SslConnection* connection, Ssl::SslSocket::SocketState state) {
	...
	case SslSocket::SS_Disconnected:{
		...
		std::set<SslConnection*>::iterator p = _connections.find(connection);
