...
RF08_forICARTT.CO_PPBV=GV.CO_PPB(TAKEOFF2);
RF08_forICARTT.PALTF=GV.PALTF(TAKEOFF2);
RF08_forICARTT.TIME=GV.TIME(TAKEOFF2);
RF08_forICARTT.DOY=GV.DOY(TAKEOFF2);
RF08_forICARTT.CO2_dry_ppm=PICARRO_CALIBRATED.CO2_dry_ppm(TAKEOFF2);
RF08_forICARTT.CH4_dry_ppm=PICARRO_CALIBRATED.CH4_dry_ppm(TAKEOFF2);




filename=['RF08_forICARTT_data.mat'];


cd C:\Users\kaser\Documents\CONTRAST\matlab\RF08\resultsRF08\
save(filename,'RF08_forICARTT')
