...
/*  S1CON  */
#define SM0_MSK  0x80  // alternatively "FE"
//#define FE_MSK   0x80
#define SM1_MSK  0x40
#define SM2_MSK  0x20
#define REN_MSK  0x10
...
/*  P1  */
sbit shuttle_sense          = P1^7;
//sbit slide_pickup_inhibit     = P1^7;
sbit shuttle_inhibit        = P1^6;
sbit RST     = P1^5;
sbit INT1    = P1^4;
...
sbit slide_pickup_sense     = P0^0;
sbit slide_pickup_inhibit   = P0^1;
//sbit shuttle_sense          = P0^1;
sbit linear_stage_sense     = P0^2;
sbit slide_ret_act_sense    = P0^3;
/*
sbit slide_pickup_home  = P0^4;
sbit slide_pickup_cas   = P0^5;
sbit slide_pickup_tran  = P0^6;
sbit slide_act_home     = P0^7;
*/
/* P2 */

sbit carousel_sense         = P2^0;
sbit carousel_inhibit       = P2^1;
sbit linear_stage_inhibit   = P2^3;
sbit slide_ret_act_inhibit  = P2^4;
