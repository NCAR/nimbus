...
'OPEN "C:" + FILENAME$ + ".HKD" FOR APPEND AS #1   'TO WRITE COLUMN HEADINGS
...
'OPEN "C:" + FILENAME$ + ".RAW" FOR APPEND AS #2   'TO WRITE COLUMN HEADINGS
...
END IF          'CODE FOR SHORT FILES ENDS HERE:COMMENT OUT FOR LONG FORMAT
   ...
   OPEN "C:" + FILENAME$ + ".HKD" FOR APPEND AS #1
   OPEN "C:" + FILENAME$ + ".RAW" FOR APPEND AS #2
