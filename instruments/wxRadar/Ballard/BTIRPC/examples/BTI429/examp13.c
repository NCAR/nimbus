...
/**
*
*  BTI429 DRIVER EXAMPLE 13  (10/23/2009)
...
*  ALL RIGHTS RESERVED
*
*  NAME:   EXAMP13.C -- Monitor DMA example
*
**/
...
**/
	...
	errval = BTICard_SeqConfig(SEQCFG_DEFAULT | SEQCFG_DMA,hCore);
...
**/
	...
	while(1)
	{
		...
		seqcount = BTICard_SeqDMARd(seqbuf,sizeof(seqbuf)/sizeof(seqbuf[0]),hCore);
