...
/**
*
*  BTI717 DRIVER EXAMPLE 3  (10/23/2009)
...
**/
	...
	while(1)
	{
		...
		while(!BTICard_SeqFindNext717(&pRec717,&sfinfo))
		{
			...
			if (BTICard_SeqFindCheckVersion((LPUINT16)pRec717, SEQVER_1))
			{
				consoleprintf("%08lX ",pRec717->timestamph);
			}

			consoleprintf("%08lX",pRec717->timestamp);
		}
	}
