...
/**
*
*  BTI1553 DRIVER EXAMPLE 25  (10/23/2009)
*  Copyright (c) 2009
...
**/
	...
	while (1)
	{
		...
		consoleprintf("\rReceived data {%04XH, %04XH, %04XH}\tTimetag {%08X}",msgfields.data[0],msgfields.data[1],msgfields.data[2],msgfields.timetag);
	}
