...
/**
*
*  BTI1553 DRIVER EXAMPLE 26  (10/23/2009)
*  Copyright (c) 2009
...
*  ALL RIGHTS RESERVED
*
*  NAME:   EXAMP26.C -- BC scheduling DIO
*
**/
...
*
*  The LED and a DOUT line is toggled each loop of the schedule.
*
**/
...
**/
	...
	BTI1553_BCSchedFrame(FRAMETIME,channum,hCore);
	BTI1553_BCSchedMsg(BCMsgs[0],  channum,hCore);
	BTI1553_BCSchedPulse(doutnum,  channum,hCore);
