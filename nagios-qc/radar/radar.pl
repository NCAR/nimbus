#Julian Quick, SUPER intern 2014
#This code taken from nagios exchange
#
#if problems arise, try sudo perl -MCPAN -e shell
# > install File::Pid
...
#my $PID_FILE_DIRECTORY="/usr/local/lib64/perl5";              
...
my $CFG_CREATION_INTERVAL=300;                                          #Changes efficiency
