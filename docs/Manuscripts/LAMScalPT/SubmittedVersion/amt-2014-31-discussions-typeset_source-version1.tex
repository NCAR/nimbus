...
\subsubsection{``$d$~Value''\blackbox{Please confirm.} measurements during speed runs}
...
\subsection{C-130\blackbox{Please confirm section numbering.}}
...
measurements at about 22:13:15\blackbox{Please provide time zone.} was caused by loss of signal as
...
$c_{vp}$\blackbox{Please check. Did you mean $c_{v\mathrm{d}}$?} are very close to
...
\bibitem[{Balachandran(2006)}]{balachandran2006fundamentals}
Balachandran,~P.: {Fundamentals of Compressible Fluid Dynamics},
Prentice-Hall of India Pvt-Ltd, available at: \url{http://books.google.com/books?id=KEzdXmXgaHkC}\blackbox{Please provide last access date.}, 2006.
...
\url{http://nldr.library.ucar.edu/repository/collections/TECH-NOTE-000-000-000-579}\blackbox{Please provide last access date.}, 1988.
...
available at: \url{http://nldr.library.ucar.edu/repository/collections/TECH-NOTE-000-000-000-064}\blackbox{Please provide last access date.},
1972.
...
available at: \url{http://www.R-project.org}\blackbox{Please provide last access date.}, 2013.
