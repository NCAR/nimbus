...
// Pull in the data.
  memcpy(buf[ptog], datap, OPH3_DATA_LEN);
...
// Check the data alignment.
  if (((p[OPH3_GAIN_IDX]==OPH3_GAIN1) || (p[OPH3_GAIN_IDX]==OPH3_GAIN2) ||
       (p[OPH3_GAIN_IDX]==OPH3_GAIN3) || (p[OPH3_GAIN_IDX]==OPH3_GAIN0)) &&
      ((p[OPH3_BB_IDX]==OPH3_BB_NORM) || (p[OPH3_BB_IDX]==OPH3_BB_ZERO) ||
       (p[OPH3_BB_IDX]==OPH3_BB_COOL) || (p[OPH3_BB_IDX]==OPH3_BB_HEAT))) {
 
// Parse the ophir 3 data string and build the recorded data block.
    sscanf(p, "%hu %s %hu %hu %hu %hu %hu %hu %hu %hu %hu",
