...
/* telSer.h                                                    */
/*                                                             */
/* defines used for telemetry system                           */
/*                                                             */
...
/* Z85C30 SCC Registers */
# define PORT_A IP_B_BASE+5
# define PORT_B IP_B_BASE+1

// interrupt
# define IPSERIAL_VCT	0x60
...
#define IPIC_INT_CTL_INT        (char)0x20              /* int pend status   */
...
// MVIP-301 Global Variables
SEM_ID sem301;    // MVIP-301 Semaphore
SCC *pSPA = (SCC *)PORT_A;       //pointer serial port A control structure

// MVIP-301 Prototypes
void sccISR(void);         // MVIP-301 ISR
void sccInit(void);  // MVIP-301 Initialization routine
int writeSP(char *data, int numBytes); // SPA output routine
